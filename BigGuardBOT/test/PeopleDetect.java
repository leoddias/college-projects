...
final class PeopleDetect {
    ...
    public static void main(final String... args) {
        ...
        String url = "C:\\walking.mp4";
        final String outputFile = "C:/people-detect-java.avi";
        ...
        final CaptureUI window = new CaptureUI(videoCapture);
        ...
        final FourCC fourCC = new FourCC("XVDI");
